...
const App = () => (
	<div className="row">
		<div className="col-xl-8 mb-4">
			...
			<p>This is a place where all the TC Resources are collected to help you find things more easily. If you feel like there is something missing or there is a feature you would like to see, please send me message on slack @amelie - any kind feedback is welcome.</p>
			<SearchResults />
			<QuickLinks />
			<div className="row">
